...
def recast_variables(ds: xr.Dataset) -> xr.Dataset:
    ...
    var_mapping = {
        "T": "T",
        "dT": "dT",
        "dlnVs_lin": "dlnVs_lin_percent",
        "dlnVp_lin": "dlnVp_lin_percent",
        "dlnVs": "dlnVs_linan_percent",
        "dlnVp": "dlnVp_linan_percent",
        "dlnVs_reparam": "dlnVs_reparam_percent",
        "dlnVp_reparam": "dlnVp_reparam_percent",
        "dlnVs_tofi": "dlnVs_tofi_percent",
        "dlnVp_tofi": "dlnVp_tofi_percent",
    }
